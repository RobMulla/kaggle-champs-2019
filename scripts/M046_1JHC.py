...
def fit_meta_feature(X_train, X_valid, X_test, Meta_train, train_idx, bond_type, base_fold, feature='fc',
                     N_META_FOLDS=N_META_FOLDS, N_META_ESTIMATORS=N_META_ESTIMATORS):
    """
...
for bond_type in types:
    ...
    for fold_n, (train_idx, valid_idx) in enumerate(folds.split(X_type, groups=mol_group_type)):
        ...
        if MODEL_TYPE == 'lgbm':
            ...
            X_train, X_valid, X_test_type = fit_meta_feature(X_train, X_valid, X_test_type, Meta_train, train_idx, bond_type, fold_count)
            ...
            X_train, X_valid, X_test_type = fit_meta_feature(X_train, X_valid, X_test_type,
                                                             Meta_train, train_idx, bond_type, fold_count, feature='fc')
#             X_train, X_valid, X_test_type = fit_meta_feature(X_train, X_valid, X_test_type,
#                                                              Meta_train, train_idx, bond_type, fold_count, feature='sd')
#             X_train, X_valid, X_test_type = fit_meta_feature(X_train, X_valid, X_test_type,
#                                                              Meta_train, train_idx, bond_type, fold_count, feature='pso')
#             X_train, X_valid, X_test_type = fit_meta_feature(X_train, X_valid, X_test_type,
#                                                              Meta_train, train_idx, bond_type, fold_count, feature='dso')
            DEPTH = 7
