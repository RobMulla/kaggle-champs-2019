...
types = ['1JHN', '2JHH', '2JHN', '3JHH', '1JHC', '2JHC','3JHC', '3JHN']
...
for bond_type in types:
    ...
    train_df = pd.read_parquet('data/FE012-train-{}.parquet'.format(bond_type)) 
    test_df = pd.read_parquet('data/FE012-test-{}.parquet'.format(bond_type)) 
