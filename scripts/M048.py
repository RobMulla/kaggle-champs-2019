...
def fit_meta_feature(X_train, X_valid, X_test, Meta_train,
    ...
    update_tracking(run_id, '{}_meta_{}_lmae_cv_f{}'.format(bond_type, feature, base_fold), log_oof_score)

    feature_importance.to_parquet(
        'type_results/{}/meta/{}_{}_{}_fi_meta_{}_f{}_{:0.4f}MAE_{:0.4f}LMAE.parquet'.format(bond_type,
                                                                                      MODEL_NUMBER,
                                                                                      run_id,
                                                                                      bond_type,
                                                                                      feature,
    ...
    X_train_oof.to_parquet('type_results/{}/meta/{}_{}_{}_oof_meta_{}_f{}_{:0.4f}MAE_{:0.4f}LMAE.parquet'.format(bond_type,
                                                                                      MODEL_NUMBER,
                                                                                      run_id,
                                                                                      bond_type,
                                                                                      feature,
    ...
    X_train.to_parquet('type_results/{}/meta/{}_{}_{}_X_train_meta_{}_f{}_{:0.4f}MAE_{:0.4f}LMAE.parquet'.format(bond_type,
                                                                                      MODEL_NUMBER,
                                                                                      run_id,
                                                                                      bond_type,
                                                                                      feature,
    ...
    X_valid.to_parquet('type_results/{}/meta/{}_{}_{}_X_valid_meta_{}_f{}_{:0.4f}MAE_{:0.4f}LMAE.parquet'.format(bond_type,
                                                                                      MODEL_NUMBER,
                                                                                      run_id,
                                                                                      bond_type,
                                                                                      feature,
...
def save_type_data(type_, oof, sub, fi, MODEL_NUMBER,
    ...
    if score > 1:
        ...
        return
    print(f'===== Saving results for for type {type_} - mae {score} - log mae {logscore}')
...
for bond_type in types:
    ...
    train_df = pd.read_parquet('data/FE019/FE019-train-{}.parquet'.format(bond_type))
    test_df = pd.read_parquet('data/FE019/FE019-test-{}.parquet'.format(bond_type))
...
#     now = timer()
    ...
    save_type_data(bond_type, oof_df, sub, feature_importance, MODEL_NUMBER,
                   run_id, MODEL_TYPE, N_FOLDS,
                   N_ESTIMATORS, LEARNING_RATE)
