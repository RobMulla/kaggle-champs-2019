...
for bond_type in types:
    ...
    train_df = pd.read_parquet('data/FE014/FE014-train-{}.parquet'.format(bond_type)) 
    test_df = pd.read_parquet('data/FE014/FE014-test-{}.parquet'.format(bond_type)) 
