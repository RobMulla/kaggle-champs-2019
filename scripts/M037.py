...
New Changes:
    ...
    - 2 Folds
    - 0.1 learning rate
    - 500k estimators total
    - FE015 - More angle features
Old Changes:
...
types = ['2JHN', '1JHN', '3JHN', '2JHH', '3JHH', '1JHC', '2JHC', '3JHC']
# types = ['1JHC']
...
for bond_type in types:
    ...
    train_df = pd.read_parquet('data/FE015/FE015-train-{}.parquet'.format(bond_type)) 
    test_df = pd.read_parquet('data/FE015/FE015-test-{}.parquet'.format(bond_type)) 
